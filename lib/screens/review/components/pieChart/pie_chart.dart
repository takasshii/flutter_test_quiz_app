      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            color: kGreenColor,
            value: ((questionDataListAll[widget.index]
                        .where((element) => element.latestCorrect == 1)
                        .length
                        .toDouble() /
                    pastPaper100.length) *
        ...
        case 1:
          return PieChartSectionData(
            ...
            value: ((questionDataListAll[widget.index]
                ...
                100),
            title:
                '${((questionDataListAll[widget.index].where((element) => element.latestCorrect == 0).length.toDouble() / pastPaper100.length) * 100).toInt()}%',
            radius: radius,
            titleStyle: TextStyle(
                fontSize: fontSize,
                fontWeight: FontWeight.bold,
        ...
        case 2:
          return PieChartSectionData(
            ...
            value: (((pastPaper100.length -
                        questionDataListAll[widget.index].length.toDouble()) /
                    pastPaper100.length) *
                100),
            title:
                '${(((pastPaper100.length - questionDataListAll[widget.index].length.toDouble()) / pastPaper100.length) * 100).toInt()}%',
            radius: radius,
            titleStyle: TextStyle(
                fontSize: fontSize,
                fontWeight: FontWeight.bold,
